...
else if(isset($_SESSION['username']) && isset($_SESSION['key']) && $_SESSION['key'] == 'admin'){
...
function validateForm() {
  ...
  var m = document.forms["form"]["age"].value;
  if (m == null || m<5 || m>120) {
    document.getElementById("errormsg").innerHTML="Age must be at least 5 years";
    return false;
  }
...
<div class="row">
<div class="col-lg-6">
<span class="logo" >Online IQ Test</span>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" class="form-control input-md" type="text" value="<?php if(isset($_GET['name'])){
      $name = $_GET['name']; 
 }else{
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="age" name="age" class="form-control input-md" type="number" value="<?php
echo $_GET['age'];
?>">
...
?>>Male</option>
  <option value="F" <?php
if (isset($_GET['gender']) == "F")
    echo "selected";
?>>Female</option>
  <option value="O" <?php
if (isset($_GET['gender']) == "O")
    echo "selected";
?>>Others</option>
 </select>
  </div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="username" name="username" class="form-control input-md" type="username" value="<?php
if(isset($_GET['username'])){
      $username = $_GET['username']; 
 }else{
      $username = "Name not set in GET Method";
 }
?>" style="<?php
if (isset($_GET['q7']))
...
<div class="form-group">
  <label class="control-label" for="phno">&nbsp;&nbsp;&nbsp;&nbsp;Mobile No.</label>  
  <div class="col-md-12">
  <input id="phno" name="phno" class="form-control input-md" type="number" value="<?php
echo $_GET['phno'];
?>">
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="cpassword" name="cpassword" class="form-control input-md" type="password">
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">About Online IQ Test</a></div>
</div>
