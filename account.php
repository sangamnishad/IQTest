...
<div class="row">
<div class="col-lg-6">
<span class="logo">Online IQ Test</span></div>
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Total question</b></td><td style="vertical-align:middle"><b>Correct Answer</b></td><td style="vertical-align:middle"><b>Wrong Answer</b></td><td style="vertical-align:middle"><b>Total Points</b></td><td style="vertical-align:middle"><b>Time limit</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
...
function end(){
  data = prompt("Are you sure to end this Test? Remember, once finished, you wont be able to continue anymore and final results will be displayed. If you want to continue then enter \\"yes\\" in the textbox below and press enter");
  if(data=="yes"){
...
var countdownTimer = setInterval(\'secondPassed()\', 1000);
            ...
            echo '<font size="3" style="margin-left:100px;font-family:\'typo\' font-size:20px; font-weight:bold;color:darkred">Time Left : </font><span class="timer btn btn-default" style="margin-left:20px;"><font style="font-family:\'typo\';font-size:20px;font-weight:bold;color:darkblue" id="countdown"></font></span><span class="timer btn btn-primary" style="margin-left:50px" onclick="end()"><span class=" glyphicon glyphicon-off"></span>&nbsp;&nbsp;<font style="font-size:12px;font-weight:bold">Finish Test</font></span>';
            $eid   = @$_GET['eid'];
            $sn    = @$_GET['n'];
            $total = @$_GET['t'];
...
<br />';
            ...
            for ($i = 1; $i <= $total; $i++) {
                echo '<a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . $i . '&t=' . $total . '"  style="margin:5px;padding:5px;height: 100px;background-color:';
                if ($quesans[$i]) {
                    echo "darkgreen";
                } else {
                    echo "darkred";
...
<center><h1 class="title" style="color:darkgreen">Your IQ is '.$s.'</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';

        echo '<div class="panel">
<center><h1 class="title" style="color:#660033">Review</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
    ...
    echo'
    <tr style="color:darkblue"><td style="vertical-align:middle">IQ Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Test</b></td><td style="vertical-align:middle"><b>Date &nbsp;&nbsp;&nbsp; & &nbsp;&nbsp;&nbsp;Time</b></td><td style="vertical-align:middle"><b>Total Questions</b></td><td style="vertical-align:middle"><b>Right</b></td><td style="vertical-align:middle"><b>Wrong<b></td><td style="vertical-align:middle"><b>Unattempted<b></td><td style="vertical-align:middle"><b>IQ Score</b></td><td style="vertical-align:middle"><b>Action<b></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($q)) {
        $eid = $row['eid'];
        $s   = $row['score'];
        ...
        echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . isset($title) . '</td>
        <td style="vertical-align:middle">' . $date . '</td><td style="vertical-align:middle">' . isset($total) . '</td><td style="vertical-align:middle">' .isset($r) . '</td><td style="vertical-align:middle">' . $w . '</td><td style="vertical-align:middle">' . (isset($total) - $r - $w) . '</td>';
         $s = ($r/$total)*100;
    if($s <= 1)
    {
        $s = 65;
    ...
    elseif ($s >90 && $s <=100) {
        ...
        echo'<td style="vertical-align:middle">' . $s . '</td><td style="vertical-align:middle"><b><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result</b></td></tr>';
    }
    echo '</table></div>';
}
if (@$_GET['q'] == 3) {
...
<span href="#" data-target="#login" style="color:lightyellow">Organized by Sangam Nishad, Mumbai.<br><br></span></div>
...
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;text-decoration:underline" onmouseover="this.style('color:yellow')" target="new">About Online IQ Test</a></div>
</div>
</body>
</html>
